...
// if (!isset($merk)) {
//     $total_records = count(query("SELECT * FROM tb_barang WHERE kategori = '$kategori'"));
//     $total_pages = ceil($total_records / $limit);
//     $produk = query("SELECT * FROM tb_barang WHERE kategori = '$kategori' LIMIT $start, $limit");
// } else {
//     $total_records = count(query("SELECT * FROM tb_barang WHERE kategori = '$kategori' && merk = '$merk'"));
//     $total_pages = ceil($total_records / $limit);
//     $produk = query("SELECT * FROM tb_barang WHERE kategori = '$kategori' && merk = '$merk' LIMIT $start, $limit");
// }
?>
